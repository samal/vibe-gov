...
INSERT INTO audit_logs_enhanced (actor_user_id, action, entity_type, entity_id, resource_type, resource_id, old_values, new_values, ip_address, user_agent, metadata) VALUES 
  ...
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'SYSTEM_INITIALIZED', 'SYSTEM', 'startup', 'SYSTEM', 'initialization', '{}', '{"version": "1.0.0", "timestamp": "2025-01-15T00:00:00Z"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"component": "database", "action": "seed_data_inserted"}'),
  
  -- User creation events
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'CREATE_USER', 'USER', 'steward-001', 'USER', 'steward@lineage.com', '{}', '{"email": "steward@lineage.com", "displayName": "Data Steward", "role": "DATA_STEWARD"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'CREATE_USER', 'USER', 'engineer-001', 'USER', 'engineer@lineage.com', '{}', '{"email": "engineer@lineage.com", "displayName": "Data Engineer", "role": "DATA_ENGINEER"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  
  -- Classification events
  ((SELECT id FROM users WHERE email = 'steward@lineage.com'), 'CREATE_CLASSIFICATION', 'CLASSIFICATION', 'PII', 'CLASSIFICATION', 'PII', '{}', '{"key": "PII", "label": "Personally Identifiable Information", "description": "Data that can identify a specific individual"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  ((SELECT id FROM users WHERE email = 'steward@lineage.com'), 'CREATE_CLASSIFICATION', 'CLASSIFICATION', 'FINANCIAL', 'CLASSIFICATION', 'FINANCIAL', '{}', '{"key": "FINANCIAL", "label": "Financial Data", "description": "Sensitive financial information including transactions and balances"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  
  -- Asset classification events
  ((SELECT id FROM users WHERE email = 'steward@lineage.com'), 'ASSIGN_CLASSIFICATION', 'ASSET', 'pg.public.users', 'CLASSIFICATION', 'PII', '{}', '{"classificationKey": "PII", "assetId": "pg.public.users"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  ((SELECT id FROM users WHERE email = 'steward@lineage.com'), 'ASSIGN_CLASSIFICATION', 'ASSET', 'pg.public.orders', 'CLASSIFICATION', 'FINANCIAL', '{}', '{"classificationKey": "FINANCIAL", "assetId": "pg.public.orders"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  
  -- Masking rule events
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'CREATE_MASKING_RULE', 'MASKING_RULE', '1', 'MASKING_RULE', 'PII Redaction for Viewers', '{}', '{"name": "PII Redaction for Viewers", "classificationKey": "PII", "roleId": 5, "maskingType": "REDACT"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'CREATE_MASKING_RULE', 'MASKING_RULE', '2', 'MASKING_RULE', 'PII Hashing for Analysts', '{}', '{"name": "PII Hashing for Analysts", "classificationKey": "PII", "roleId": 4, "maskingType": "HASH"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  
  -- Data asset events
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'CREATE_ASSET', 'DATA_ASSET', 'pg.public.users', 'DATA_ASSET', 'pg.public.users', '{}', '{"id": "pg.public.users", "name": "users", "namespace": "public", "sourceSystem": "postgres", "assetType": "TABLE"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'CREATE_ASSET', 'DATA_ASSET', 'pg.public.orders', 'DATA_ASSET', 'pg.public.orders', '{}', '{"id": "pg.public.orders", "name": "orders", "namespace": "public", "sourceSystem": "postgres", "assetType": "TABLE"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data"}'),
  
  -- Login events
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'USER_LOGIN', 'USER', 'admin-001', 'USER', 'admin@lineage.com', '{}', '{"timestamp": "2025-01-15T00:00:00Z", "ip": "127.0.0.1"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "session_id": "seed-session-001"}'),
  ((SELECT id FROM users WHERE email = 'steward@lineage.com'), 'USER_LOGIN', 'USER', 'steward-001', 'USER', 'steward@lineage.com', '{}', '{"timestamp": "2025-01-15T00:00:00Z", "ip": "127.0.0.1"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "session_id": "seed-session-002"}')
ON CONFLICT DO NOTHING;
...
INSERT INTO audit_logs_enhanced (actor_user_id, action, entity_type, entity_id, resource_type, resource_id, old_values, new_values, ip_address, user_agent, metadata) VALUES 
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'pg.public.users->pg.public.orders', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "pg.public.users", "downstream": "pg.public.orders", "transformation": "JOIN"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_table"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'pg.public.orders->pg.public.order_items', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "pg.public.orders", "downstream": "pg.public.order_items", "transformation": "JOIN"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_table"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'pg.public.products->pg.public.order_items', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "pg.public.products", "downstream": "pg.public.order_items", "transformation": "JOIN"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_table"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'pg.public.users+pg.public.orders->pg.public.user_summary', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": ["pg.public.users", "pg.public.orders"], "downstream": "pg.public.user_summary", "transformation": "VIEW"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_view"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'pg.public.orders+pg.public.order_items+pg.public.products->pg.public.product_performance', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": ["pg.public.orders", "pg.public.order_items", "pg.public.products"], "downstream": "pg.public.product_performance", "transformation": "VIEW"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_view"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'pg.public.user_summary->tableau.sales.customer_dashboard', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "pg.public.user_summary", "downstream": "tableau.sales.customer_dashboard", "transformation": "TABLEAU_EXTRACT"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "view_to_report"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'pg.public.orders->tableau.finance.revenue_analysis', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "pg.public.orders", "downstream": "tableau.finance.revenue_analysis", "transformation": "TABLEAU_EXTRACT"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_report"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'pg.public.products->tableau.inventory.stock_monitoring', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "pg.public.products", "downstream": "tableau.inventory.stock_monitoring", "transformation": "TABLEAU_EXTRACT"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_report"}'),
  
  -- MySQL lineage relationships
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.sales.customers->mysql.sales.orders', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "mysql.sales.customers", "downstream": "mysql.sales.orders", "transformation": "JOIN"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_table"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.sales.orders->mysql.sales.order_items', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "mysql.sales.orders", "downstream": "mysql.sales.order_items", "transformation": "JOIN"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_table"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.inventory.products->mysql.sales.order_items', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "mysql.inventory.products", "downstream": "mysql.sales.order_items", "transformation": "JOIN"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_table"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.inventory.suppliers->mysql.inventory.products', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "mysql.inventory.suppliers", "downstream": "mysql.inventory.products", "transformation": "JOIN"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_table"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.sales.orders->mysql.finance.transactions', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "mysql.sales.orders", "downstream": "mysql.finance.transactions", "transformation": "JOIN"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_table"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.sales.customers+mysql.sales.orders->mysql.sales.customer_summary', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": ["mysql.sales.customers", "mysql.sales.orders"], "downstream": "mysql.sales.customer_summary", "transformation": "VIEW"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_view"}'),
  ...
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.sales.customer_summary->tableau.sales.customer_dashboard', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "mysql.sales.customer_summary", "downstream": "tableau.sales.customer_dashboard", "transformation": "TABLEAU_EXTRACT"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "view_to_report"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.finance.transactions->tableau.finance.revenue_analysis', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "mysql.finance.transactions", "downstream": "tableau.finance.revenue_analysis", "transformation": "TABLEAU_EXTRACT"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "table_to_report"}'),
  ((SELECT id FROM users WHERE email = 'engineer@lineage.com'), 'CREATE_LINEAGE', 'LINEAGE', 'mysql.inventory.stock_alerts->tableau.inventory.stock_monitoring', 'LINEAGE', 'FLOWS_TO', '{}', '{"upstream": "mysql.inventory.stock_alerts", "downstream": "tableau.inventory.stock_monitoring", "transformation": "TABLEAU_EXTRACT"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"source": "seed_data", "lineage_type": "view_to_report"}')
ON CONFLICT DO NOTHING;

-- Log completion of seed data insertion
INSERT INTO audit_logs_enhanced (actor_user_id, action, entity_type, entity_id, resource_type, resource_id, old_values, new_values, ip_address, user_agent, metadata) VALUES 
  ((SELECT id FROM users WHERE email = 'admin@lineage.com'), 'SEED_DATA_COMPLETED', 'SYSTEM', 'database', 'SYSTEM', 'seed_data', '{}', '{"status": "completed", "timestamp": "2025-01-15T00:00:00Z", "records_inserted": "seed_data_complete"}', '127.0.0.1', 'LineageNexus/1.0.0', '{"component": "database", "action": "seed_data_completed", "summary": "All seed data successfully inserted"}');
